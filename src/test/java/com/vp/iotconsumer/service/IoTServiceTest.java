package com.vp.iotconsumer.service;
...
//import com.vp.iotconsumer.repo.Reopsitory;
...
public class IoTServiceTest {
     ...
     @InjectMocks
    private Services ioTService;

    @Mock
    private Diractory ioTRepository;
    ...
    private static final String VALID_CSV = "E:\\netbeansWorkspace\\iotconsumer\\src\\test\\resources\\data2.csv";

    @BeforeAll
    public static void setUp() {
        mockStatic(CsvProcess.class);
    }
    ...
    public void loadData_validCsvPathAsInput_validIotResponseDto() throws FileNotFoundException {
        ...
        given(CsvProcess.processTrackingDevicesFile(anyString())).willReturn(anyList());

        // When
        IoTResponseDTO ioTResponseDTO = ioTService.loadDate(ioTRequestDTO);
    ...
    public void loadData_parseInvalidCsv_fileNotFoundException() throws FileNotFoundException {
        ...
        given(CsvProcess.processTrackingDevicesFile(ioTRequestDTO.getFilepath()))
                .willThrow(FileNotFoundException.class);

        // When-Then
        assertThrows(FileNotFoundException.class, () -> ioTService.loadDate(ioTRequestDTO));
    }
    ...
    public void loadData_parseInvalidCsv_runtimeException() throws FileNotFoundException {
        ...
        // When-Then
        assertThrows(RuntimeException.class, () -> ioTService.loadDate(ioTRequestDTO));
    }
