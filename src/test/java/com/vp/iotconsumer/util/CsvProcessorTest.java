package com.vp.iotconsumer.util;
...
public class CsvProcessorTest {
    ...
    private static final String INVALID_PATH = "E:\\netbeansWorkspace\\iotconsumer\\src\\test\\resources\\123.csv"; // This file doesn't exists.
    private static final String INVALID_CSV = "E:\\netbeansWorkspace\\iotconsumer\\src\\test\\resources\\invalidData.csv";
    private static final String VALID_CSV = "E:\\netbeansWorkspace\\iotconsumer\\src\\test\\resources\\data.csv";
    ...
    public void processTrackingDevicesFile_mapValidCsv_validIoTList() throws Exception {
        ...
        // When
        List<IoT> iotList = CsvProcess.processTrackingDevicesFile(VALID_CSV);
    ...
    public void processTrackingDevicesFile_mapInvalidCsv_runtimeException() {
        // When
        Exception exception = assertThrows(RuntimeException.class, () -> CsvProcess.processTrackingDevicesFile(INVALID_CSV));
    ...
    public void processTrackingDevicesFile_invalidPathProvided_fileNotFoundException() {
        // When
        Exception exception = assertThrows(FileNotFoundException.class, () -> CsvProcess.processTrackingDevicesFile(INVALID_PATH));

        //Then
        assertThat(exception.getMessage(), is("E:\\netbeansWorkspace\\iotconsumer\\src\\test\\resources\\123.csv (The system cannot find the file specified)"));
    }
